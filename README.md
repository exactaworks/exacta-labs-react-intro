...
## Conteúdo
- [00 - Introdução](#introdução)
- [01 - Criando o projeto com CRA](#1---criando-o-projeto-com-create-react-app-cra)
- [02 - Criando a estrutura base da To Do List com JSX](#2---criando-a-estrutura-base-da-to-do-list-com-jsx)
- [03 - Componentização](#3---componentização)
- [04 - Criando um estado com useState](#4---criando-um-estado-state-com-usestate)
- [05 - Implementando ciclo de vida com useEffect](#5---implementando-ciclo-de-vida-com-useeffect)
- [06 - Atualizando e removendo tasks através de parâmetros](#6---atualizando-e-removendo-tasks-através-de-parâmetros)
- [07 - Refatorando e corrigindo "Prop Drilling"](#7---refatorando-e-corrigindo-prop-drilling)
- [08 - Instalando e configurando JSON Server](#8---instalando-e-configurando-json-server)
- [09 - Consumindo API Fake com Fetch](#9---consumindo-api-fake-com-fetch)
